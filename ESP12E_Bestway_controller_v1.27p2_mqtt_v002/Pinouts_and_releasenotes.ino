/*  v002 877dev: 
 *  Combined websocket and mqtt inputs to VA's commandAction function
 *  Included required "MQTTclient.loop" code into loop, needs to be called frequently to process MQTT callback's
 *  disable OTA password, due to cannot OTA update LittleFS data (authentication failed)
 * 
 * patch 2
 * 
