...
//********USER PARAMETERS*************
const char *OTAName = "BW-1.27p2_MQTT_v002";     // A name and a password for the OTA service
...
String base_mqtt_topic =          "BW-1.27_MQTT";                // Start of the MQTT Topic name used by this device
