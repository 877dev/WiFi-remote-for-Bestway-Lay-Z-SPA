...
void startup() {
  ...
  playIntro(); //877dev optionally disable
...
void startOTA() { // Start the OTA service
  ...
  //ArduinoOTA.setPassword(OTAPassword);  //877dev enabling password stops LittleFS upload OTA
...
void startMQTT() { //MQTT setup and connect - 877dev
  ...
  {
  Serial.println("MQTT buffer size successfully increased");
  }
